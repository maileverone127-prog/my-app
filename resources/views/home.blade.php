...
{{-- ================================================================
     HERO
================================================================ --}}
<section class="relative overflow-hidden bg-white dark:bg-gray-950 py-28 transition-colors duration-300">

    {{-- Subtle background gradient blob --}}
    <div class="absolute -top-24 -right-24 w-96 h-96 rounded-full bg-indigo-100 dark:bg-indigo-900/20 blur-3xl opacity-60 pointer-events-none"></div>
    <div class="absolute -bottom-24 -left-24 w-80 h-80 rounded-full bg-purple-100 dark:bg-purple-900/20 blur-3xl opacity-50 pointer-events-none"></div>
    ...
    <div class="relative max-w-5xl mx-auto px-6 text-center">
        ...
        <div class="inline-flex items-center px-5 py-2 rounded-full
                    ...
                    text-sm font-medium shadow-sm border border-indigo-100 dark:border-indigo-800">
            🚀 Building Scalable Web Applications
        </div>

        <h1 class="mt-8 text-5xl md:text-6xl font-extrabold text-gray-900 dark:text-white tracking-tight"
            data-aos="fade-up" data-aos-delay="100">
            Kushal Ghimire
        </h1>

        <h2 class="mt-4 text-xl md:text-2xl text-indigo-600 dark:text-indigo-400 font-semibold"
        ...
        {{-- CTA Buttons + Social --}}
        <div class="mt-10 flex flex-col items-center gap-6" data-aos="fade-up" data-aos-delay="250">
            ...
            {{-- Social icons --}}
            <div class="flex items-center gap-8 text-3xl text-gray-500 dark:text-gray-400">
